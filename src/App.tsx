      ...
      <main className="flex-1 p-6 flex gap-6">
        ...
        <aside className="w-80 space-y-6">
          <form action="space-y-6">
            <label
              htmlFor="video"
              className="border flex rounded-md aspect-video cursor-pointer border-dashed text-sm flex-col gap-2 items-center justify-center text-muted-foreground hover:bg-primary/5 mt-4"
            >
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <span className="block text-xs text-muted-foreground italic">
                Você poderá executar essa opção em breve.
              </span>
            </div>
